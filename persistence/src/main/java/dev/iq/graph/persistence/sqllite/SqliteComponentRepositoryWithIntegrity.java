...
/**
 * SQLite Component Repository with referential integrity support.
 * Wraps the base SqliteComponentRepository and adds referential integrity operations.
 */
public final class SqliteComponentRepositoryWithIntegrity implements ExtendedVersionedRepository<Component> {

    private final SqliteComponentRepository baseRepository;
    private final SqliteReferentialIntegrityManager integrityManager;

    public SqliteComponentRepositoryWithIntegrity(
            final SqliteComponentRepository baseRepository, final SqliteReferentialIntegrityManager integrityManager) {
