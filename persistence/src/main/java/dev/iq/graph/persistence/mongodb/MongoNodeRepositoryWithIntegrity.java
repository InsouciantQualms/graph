...
/**
 * MongoDB Node Repository with referential integrity support.
 * Wraps the base MongoNodeRepository and adds referential integrity operations.
 */
public final class MongoNodeRepositoryWithIntegrity implements ExtendedVersionedRepository<Node> {

    private final MongoNodeRepository baseRepository;
    private final MongoReferentialIntegrityManager integrityManager;

    public MongoNodeRepositoryWithIntegrity(
            final MongoDatabase database, final MongoReferentialIntegrityManager integrityManager) {
        this.baseRepository = new MongoNodeRepository(database);
