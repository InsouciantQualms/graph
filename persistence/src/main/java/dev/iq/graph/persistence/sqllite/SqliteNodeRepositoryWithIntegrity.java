...
/**
 * SQLite Node Repository with referential integrity support.
 * Wraps the base SqliteNodeRepository and adds referential integrity operations.
 */
public final class SqliteNodeRepositoryWithIntegrity implements ExtendedVersionedRepository<Node> {

    private final SqliteNodeRepository baseRepository;
    private final SqliteReferentialIntegrityManager integrityManager;

    public SqliteNodeRepositoryWithIntegrity(
            final SqliteNodeRepository baseRepository, final SqliteReferentialIntegrityManager integrityManager) {
