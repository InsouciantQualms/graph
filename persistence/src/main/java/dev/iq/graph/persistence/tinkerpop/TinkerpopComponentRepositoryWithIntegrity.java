...
/**
 * Tinkerpop Component Repository with referential integrity support.
 * Wraps the base TinkerpopComponentRepository and adds referential integrity operations.
 */
public final class TinkerpopComponentRepositoryWithIntegrity implements ExtendedVersionedRepository<Component> {

    private final TinkerpopComponentRepository baseRepository;
    private final TinkerpopReferentialIntegrityManager integrityManager;

    public TinkerpopComponentRepositoryWithIntegrity(
            final TinkerpopComponentRepository baseRepository,
            final TinkerpopReferentialIntegrityManager integrityManager) {
